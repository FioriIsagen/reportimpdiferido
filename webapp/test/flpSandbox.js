		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FI Impuesto Diferido",
									"targetURL": "#isagenreportimpdiferido-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"isagenreportimpdiferido-display": {
								"semanticObject": "isagenreportimpdiferido",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=isagen.reportimpdiferido",
									"url": sap.ui.require.toUrl("isagen/reportimpdiferido")
								}
							}
						}
					}
